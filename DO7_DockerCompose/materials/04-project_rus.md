...
Теперь в Dockerfile на базе, например, `openjdk:21-jdk-alpine`, достаточно указать инструкции, копирующие собранный проект и запускающие его командой `java -jar target/*.jar`.
